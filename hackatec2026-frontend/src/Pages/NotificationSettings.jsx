          ...
          {showGuide && (
            <div className="bg-[#f7f9fb] border border-[#e0e3e5] rounded-xl p-4 mb-4 flex flex-col gap-3">
              ...
              <ol className="flex flex-col gap-2 text-[12px] text-[#44474d] list-none">
                {[
                  <>Crea tu cuenta en <a href="https://www.emailjs.com" target="_blank" rel="noreferrer" className="text-[#964900] font-semibold hover:underline">emailjs.com</a></>,
                  'En "Email Services", conecta tu cuenta de Gmail u Outlook → copia el Service ID.',
                  'En "Email Templates", crea una plantilla usando las variables de abajo → copia el Template ID.',
                  'En "Account > API Keys", copia tu Public Key.',
                  'Pega los tres valores aquí, agrega los correos de RH y guarda.',
                ].map((step, i) => (
